...
public class GwtTestJSON extends GWTTestCase {
	...
	public void testEnum() {
		check("{\"#value\":\"SOME_ENUM\", \"@class\":\"li.tau.serializer.client.Foo$Bar\"}", foo.bar);
	}
	...
	public void testEmptyObject() {
		String jsonString = "{\"bool\":false, \"bt\":0, \"dbl\":0, \"flt\":0, \"i\":0, \"l\":0, \"s\":0, \"@class\":\"li.tau.serializer.client.Foo\"}";
	...
	public String getModuleName() {
		return "li.tau.serializer.JSONSerializer";
	}
